...
const FAQItem: React.FC<FAQItemProps> = ({ question, answer, index }) => {
  ...
  return (
    ...
    >
      ...
      {/* Toggle Button */}
      <button
        className="flex justify-center items-center bg-lime-100 rounded-full p-2.5 md:p-3.5 h-[30px] w-[3s0px]  md:h-[52px] md:w-[52px] transition-transform duration-300 ease-in-out hover:scale-105"
