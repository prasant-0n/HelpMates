          ...
          {visionPoints.map((point, index) => (
            <React.Fragment key={index}>
              ...
              <div className="flex flex-wrap gap-2.5 items-center mt-8 w-full max-md:max-w-full">
                <div className="gap-2.5 self-stretch px-2.5 my-auto w-11 h-11 text-xl font-semibold text-center whitespace-nowrap bg-lime-100 rounded-[100px] text-zinc-900">
                  {point.number}
                </div>
