...
const ContactButton: React.FC = () => {
  return (
    <div className="flex gap-2.5 items-center py-2.5 pr-2.5 pl-6 rounded-[100px] max-md:pl-5 max-md:mt-10 bg-[linear-gradient(110deg,#c7f57a,45%,#a7e667,55%,#c7f57a)] bg-[length:200%_100%] animate-background-shine">
